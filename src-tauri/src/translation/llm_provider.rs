...
impl TranslationProvider for LlmTranslator {
    ...
    async fn detect_language(&self, _text: &str) -> Result<DetectedLanguage, TranslationError> {
        Err(TranslationError::NotConfigured(
            "Use cloud provider for detection".into(),
        ))
    }
    ...
    async fn supported_languages(&self) -> Result<Vec<Language>, TranslationError> {
        ...
        Ok(vec![
            Language {
                code: "en".into(),
                name: "English".into(),
                native_name: Some("English".into()),
            },
            Language {
                code: "es".into(),
                name: "Spanish".into(),
                native_name: Some("Español".into()),
            },
            Language {
                code: "fr".into(),
                name: "French".into(),
                native_name: Some("Français".into()),
            },
            Language {
                code: "de".into(),
                name: "German".into(),
                native_name: Some("Deutsch".into()),
            },
            Language {
                code: "ja".into(),
                name: "Japanese".into(),
                native_name: Some("日本語".into()),
            },
            Language {
                code: "zh".into(),
                name: "Chinese".into(),
                native_name: Some("中文".into()),
            },
            Language {
                code: "ko".into(),
                name: "Korean".into(),
                native_name: Some("한국어".into()),
            },
            Language {
                code: "pt".into(),
                name: "Portuguese".into(),
                native_name: Some("Português".into()),
            },
            Language {
                code: "it".into(),
                name: "Italian".into(),
                native_name: Some("Italiano".into()),
            },
            Language {
                code: "ru".into(),
                name: "Russian".into(),
                native_name: Some("Русский".into()),
            },
            Language {
                code: "ar".into(),
                name: "Arabic".into(),
                native_name: Some("العربية".into()),
            },
        ])
    }
